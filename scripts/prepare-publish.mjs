...
export function prepare(root){
  ...
  for(const name of readdirSync(root)){
    ...
    const publicFile=['index.html','jobs.html','internships.html','about.html','job-search-guide.html','pay-guide.html','tracker.html','suggest.html','privacy.html','terms.html','versions.html','analytics.html','style-guide.html','404.html'].includes(name)||['robots.txt','sitemap.xml','favicon.ico','_redirects','_headers','site.webmanifest'].includes(name);
