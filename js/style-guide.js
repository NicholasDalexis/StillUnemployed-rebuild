(function (root) {
  ...
  var details = {
    ...
    casino:{intro:'Burgundy felt, gold navigation and a small stack of cards. Casino keeps the board’s handwriting and reading order while changing the atmosphere.', colors:'The whole board sits on burgundy felt. Warm cream, green and black salary cards carry the casino palette; gold belongs to navigation and selected highlights.', note:'Felt behind the cards. Gold where it helps someone find the next move.', salary:'Warm cream for the low band, green for the middle band, black and gold for the high band. Light ink belongs on the darker cards.'},
